        ...
        <div className='interview-page'>
            <div className='interview-layout'>
                ...
                <aside className='interview-sidebar'>
                    ...
                    {report.resumeScore && (
                        <div className='match-score'>
                            <p className='match-score__label'>Resume Score</p>
                            <div className={`match-score__ring ${report.resumeScore >= 80 ? 'score--high' : report.resumeScore >= 60 ? 'score--mid' : 'score--low'}`}>
                                <span className='match-score__value'>{report.resumeScore}</span>
                                <span className='match-score__pct'>%</span>
                            </div>
                        </div>
                    )}
                    ...
                    {/* ATS Score */}
                    {report.atsScore && (
                        <div className='match-score' style={{ marginTop: '16px' }}>
                            <p className='match-score__label'>ATS Score</p>
                            <div className={`match-score__ring ${report.atsScore >= 80 ? 'score--high' : report.atsScore >= 60 ? 'score--mid' : 'score--low'}`}>
                                <span className='match-score__value'>{report.atsScore}</span>
                                <span className='match-score__pct'>%</span>
                            </div>
                        </div>
                    )}
